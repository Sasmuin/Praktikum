...
\newcommand*{\varName}{MiniPET - Ein Demonstrationsversuch zur Positronen-Emissions-Tomographie}
% Datum der Durchführung (Format: JJJJ-MM-TT):
\newcommand*{\varDatum}{2019-07-01}
...
% Name des Betreuers:
\newcommand{\varBetreuer}{Daniel Winzen}
