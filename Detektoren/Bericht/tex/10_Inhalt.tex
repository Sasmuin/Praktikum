...
\begin{equation}
	E_{Backscatter} = E_{FEP} - E_{Compton}
\end{equation}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.8]{Mischquelle_pn_.png}
	\caption{Mischquelle mit einem Halbleiterdetektor aufgenommen.}
	\label{Mischquelle_pn}
\end{figure}

In \cref{Mischquelle_pn} wurde die Mischquelle mit einem Halbleiterdetektor aufgenommen. Die Peaks passen wieder gut mit den Unsicherheit überein mit $E_{CS}= \SI{661,5 \pm 0,08}{keV}$, $E_{CO2} = \SI{1172,7  \pm 0,1}{keV}$ und $E_{CO2} = \SI{1331,8 \pm 0,1}{keV}$. 

Auch im niedrigen Energiebereich stimmt der $^{137}$Am Peak mit $E_{Am} = \SI{59,54 \pm 0,07}{keV}$ mit dem Literaturwert von E = 59,5keV überein.
