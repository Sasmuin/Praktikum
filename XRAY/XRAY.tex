...
Bei der Monochomatisierung wurde gezeigt, wie der Aufbau eines Röntgenversuchs geändert werden muss, damit man statt eines Kontinuierlichem Spektrum mit verschiedenen Peaks ein Spektrum mit einer Wellenlänge bekommt. Die Motivation wieso Monochromatisierung untersucht wurde liegt in der häufigen Anwendung dieser Methode.
